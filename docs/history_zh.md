...
<div class="page-language-switch"><a href="../history_en/">English</a><span>中文</span></div>

<nav class="page-jump-links" aria-label="年份导航">
...
| 月份 | 内容 |
| ---- | ---- |
| 7    | 1. 专利工作：大语言模型的逻辑推理能力的评测方法、装置和系统<br />2. 完成一项逻辑推理工作的投稿答辩<br />3. 将一项智能体记忆与学习工作投稿至 ARR<br />4. 完成一项智能自进化方向综述的论文草稿 |
| 6    | 1. 党支部获评清华大学学生先进基层党组织、清华大学甲级团支部；个人获评清华大学学生优秀共产党员、清华大学三好学生<br />2. 完成一项智能体记忆与学习工作的首版论文<br />3. 探索智能自进化综述的自动化研究与写作流程<br />4. 承担 NeurIPS、ARR 等同行评审工作，并参与产业交流与创新创业活动 |
| 5    | 1. 2025 年度研究生党支部评议排名全校第 9 / 667 名<br />2. 完成一项逻辑推理工作的转投<br />3. 完成一项推理能力自进化工作的初稿并投稿<br />4. 完善相关研究系统的工程闭环与可视化能力<br />5. 参与企业、高校及学术团队交流与相关学术讲座 |
| 4    | 1. 4 月 28 日，软件所第一次开题通过，课题《面向基础模型推理能力自进化的关键技术研究》<br />2. 根据反馈修改专利申请材料，并完成一项 ICML 投稿的答辩工作<br />3. 推进推理能力自进化工作，完成数据合成、自动化研究、多机支持、经验抽取、规划器及评测模块等关键组件<br />4. 开展智能体执行框架相关论文学习与 Vibe Coding 实践 |
| 3    | 1. 完成一项专利申请材料的初稿<br />2. 完成一项机器学习会议投稿的答辩工作<br />3. 推进博士开题材料准备<br />4. 持续完善推理能力自进化工作的工程系统<br />5. 推进交互式运动辅导方向的人机交互工作 |
| 2    | 1. [GLM-5: from Vibe Coding to Agentic Engineering](https://arxiv.org/abs/2602.15763) 发布于 arXiv<br />2. BDMA 论文 [Towards Artificial Intelligence for Science: A Case Study of Using ChatGPT for Disease Causality Discovery from Biomedical Literature](https://ieeexplore.ieee.org/document/11373497) 正式在线出版并被 IEEE Xplore 收录<br />3. 完善一项逻辑推理工作的评测模块、时间戳机制与稳健性保障<br />4. 完成一项推理能力自进化工作的初稿，并实现部署服务与评估模块<br />5. 启动专利材料准备 |
| 1    | 1. 系统补强一项逻辑推理工作，进一步明确人工干预边界与停止条件，完善通用性、复杂逻辑定义、可靠性保障及多智能体相关工作的证据链<br />2. 推进一项推理能力自进化工作，完成整体框架图和研究计划，建设日志管理、运行管理、环境检测等工程基础，并整理强化学习相关技术笔记及中文初稿<br />3. 推进“循证医学与大模型协同决策”方向的科研项目申报材料<br />4. 探索运动、医疗、公共安全和多语言等垂直领域的大模型应用，并参加 AGI Next 峰会<br />5. 跟进交互式运动辅导方向的人机交互工作 |
