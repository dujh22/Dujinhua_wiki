...
| 类型     | 具体方向                                                     | 主要技能 | 相关成果                                                     |
| -------- | ------------------------------------------------------------ | -------- | ------------------------------------------------------------ |
| 机器学习 | 数智安全与标准化（A）                                        |          | AI算法透明性实现与评估——以推荐系统为例<br />[报告]()<br />[项目代码]() |
|          | 计算语言学（A）                                              |          | 微调中⽂预训练模型进⾏⽂本分类<br />[报告]()<br /> [项目代码]([GitHub - dujh22/CL_NLP_CCPM-CMeEE](https://github.com/dujh22/CL_NLP_CCPM-CMeEE)) |
|          | 信息检索的前沿研究（A）                                      |          | 面向多源异构健康大数据的数智医疗搜索引擎                     |
|          | 大数据分析与处理（A）                                        |          | 多模态对话场景与话题切换理解                                 |
|          | 数据挖掘：原理与算法                                         |          | 在线新闻热度预测<br />糖尿病患者入院数据聚类分析             |
|          | 知识工程                                                     |          | 基于 MAVEN 数据集实现事件抽取<br />跨语言知识图谱            |
|          | 人工智能原理                                                 |          | 基于机器学习的中英机器翻译                                   |
|          | 并行计算、算法与算法复杂性理论、组合数学                     |          | Π求解的并行化研究<br />组合数学在人工智能领域的应用          |
| 其他     | 自然辩证法概论（A），大数据分析、大数据与生物统计学、大数据实践、博士生英语（免修）、职业能力扩展训练 |          |                                                              |
